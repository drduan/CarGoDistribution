...
<nav class="navbar " role="navigation"
	...
	<div class="collapse navbar-collapse "
		...
		<ul class="nav navbar-nav navbar-left">
			...
			<li><a class=""
				href="<%=request.getContextPath()%>/User/addcar.do">添加车辆</a></li>
		</ul>
		<ul class="nav navbar-nav navbar-right">
			...
			<shiro:authenticated>
				...
				<li class="opts__item message has-unread"><a id="dLabel"
					class="dropdown-toggle-message" href="#"> <span class="sr-only">

							消息</span> <span id="messageCount" class="fa fa-bell-o">${messagecount}</span></a></li>
