...
public class MailUtil {
	 ...
	 */
	public static void sendEmail(String smtpHost, String receiver, String title, String content, String sender,
	 ...
	 * @throws Exception
	 */
	public static void sendEmail(String smtpHost, String receiver, String copy, String title, String content,
			String sender, String user, String pwd) throws Exception {
		Properties props = new Properties();
		props.put("mail.host", smtpHost);
		props.put("mail.transport.protocol", "smtp");
		// props.put("mail.smtp.host",smtpHost);//发信的主机，这里要把您的域名的SMTP指向正确的邮件服务器上，这里一般不要动！
...
//				for(int i = 0;i<20;i++)
//				{
//					sendEmail("smtp.163.com", "1416904447@qq.com", "系统测试邮件", "逗你玩", "dxd19930902@163.com", "dxd19930902",
//							"19930902dxd");
//				}
//				
//				// PropertiesUtil util = new
//				// PropertiesUtil("sysConfig.properties");
//				// sendEmail(util.readProperty("mail.smtpHost"),
//				// "411944058@qq.com","系统测试邮件",
//				// "hi,all,I am AnChao!nana", util.readProperty("mail.sender"),
//				// util.readProperty("mail.user"),
//				// util.readProperty("mail.pwd"));
//			} catch (Exception e) {
//				e.printStackTrace();
//			}
//		}
